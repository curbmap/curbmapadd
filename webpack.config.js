...
module.exports = function makeWebpackConfig() {
    ...
    if (!isTest) {
        ...
        config.entry = isTest ? {} : {
            ...
            'fal':	    'font-awesome-loader',
            'twbs': 'bootstrap-loader/lib/bootstrap.loader?extractStyles&configFilePath=./.bootstraprc!bootstrap-loader/no-op.js',
    ...
    config.output = isTest ? {} : {
        path: root('dist'),
        publicPath: isProd ? '/add/' : 'http://localhost:8082/add/',
